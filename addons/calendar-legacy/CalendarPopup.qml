...
Item {
    ...
    onTargetMasterHeightChanged: {
        if (typeof masterWindow !== "undefined") {
            masterWindow._animH = window.targetMasterHeight;
            masterWindow._stageH = window.targetMasterHeight;
        }
    }

    onTargetMasterWidthChanged: {
        if (typeof masterWindow !== "undefined") {
            masterWindow._animW = window.targetMasterWidth;
            masterWindow._stageW = window.targetMasterWidth;
    ...
    // -------------------------------------------------------------------------
    // COLORS (Serpantinum V2 ThemeBackend palette)
    // -------------------------------------------------------------------------
    ...
    readonly property string calendarClockSeconds: {
        let format = DateTime.calendarTimeFormat || "";
        if (format.indexOf("s") === -1) return "";
        let value = DateTime.calendarTime || "";
        let match = value.match(/(:\d{1,2})(?:\s|$)/);
        return match ? match[1] : "";
    }
    readonly property string calendarClockMain: {
        let value = DateTime.calendarTime || "";
        let seconds = window.calendarClockSeconds;
        if (!seconds) return value;
        let index = value.lastIndexOf(seconds);
    ...
    Item {
        ...
        Rectangle {
            ...
            Text {
                ...
                transform: [
                    Translate { y: Number(parallaxWeatherIcon.drift) || 0 },
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: window.calendarClockSeconds
                            visible: window.calendarClockSeconds !== ""
                            font.family: ThemeBackend.fontFamily
                ...
                Item {
                    ...
                    Repeater {
                        id: hourRepeater
                        model: window.weatherData && window.weatherData.forecast && window.weatherData.forecast[window.weatherView] && window.weatherData.forecast[window.weatherView].hourly ? window.weatherData.forecast[window.weatherView].hourly.slice(0, 8) : []
                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { 
                                        Layout.alignment: Qt.AlignHCenter
                                        text: modelData.time
                                        font.family: ThemeBackend.fontFamily; font.weight: Font.Bold; font.pixelSize: Math.round(12 * window.sf)
                                        color: isHighlighted ? window.base : (hrMa.containsMouse ? window.text : window.overlay1)
                                    }
                                    
                                    Text { 
                                        Layout.alignment: Qt.AlignHCenter
                                        text: modelData.icon || (window.weatherData && window.weatherData.forecast && window.weatherData.forecast[window.weatherView] ? window.weatherData.forecast[window.weatherView].icon : "")
                                    ...
                                    Text { 
                                        ...
                                        font.family: ThemeBackend.fontFamily; font.weight: Font.Black; font.pixelSize: Math.round(14 * window.sf)
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            ...
                            text: window.weatherData && window.weatherData.forecast && window.weatherData.forecast[window.weatherView] ? window.weatherData.forecast[window.weatherView].desc : ""
                            font.family: ThemeBackend.fontFamily
                            font.weight: Font.Bold
                            font.pixelSize: Math.round(16 * window.sf)
                    ...
                    RowLayout {
                        ...
                        Repeater {
                            ...
                            Item {
                                ...
                                property var forecast: window.weatherData && window.weatherData.forecast && window.weatherData.forecast[window.targetWeatherView] ? window.weatherData.forecast[window.targetWeatherView] : null
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                anchors.centerIn: parent
                                spacing: Math.round(6 * window.sf)
                                Text { text: "Open Web"; font.family: ThemeBackend.fontFamily; font.weight: Font.Bold; font.pixelSize: Math.round(14 * window.sf); color: schLinkMa.containsMouse ? window.base : window.text }
                                        ...
                                        Item {
                                            ...
                                            ColumnLayout {
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text { text: modelData.time || ""; font.family: ThemeBackend.fontFamily; font.weight: Font.Bold; font.pixelSize: Math.round(14 * window.sf); color: classNode.isActive ? window.text : window.overlay1 }
                                                }
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text { text: modelData.room || ""; font.family: ThemeBackend.fontFamily; font.weight: Font.Bold; font.pixelSize: Math.round(14 * window.sf); color: window.subtext1; elide: Text.ElideRight; Layout.fillWidth: true }
                                                }
                                            }
